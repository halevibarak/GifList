...
public class AppUtility {
    ...
    public static final String FOLDER_NAME ="GIF";
    ...
    public static void  downLoadSongToexternalStorage(Context context, String url, String fileName)
    {
        ...
        intent.putExtra(DOWNLOAD_SERVICE_FILE_NAME, fileName+".gif");
    ...
    public static void shareDownloadedGif(Context context, File file)
    {
        ...
        context.startActivity(Intent.createChooser(share, "Share Gif File"));
